...
export function render(items: any, theme = 'light') {
...
export function renderText(data: any) {
  let weight = '';
  if (data.type === 'title') {
...
export function constructItem(
  ...
  font_size: number,
  color: string = '',
  font: string = 'SegoeUI, Segoe UI, BlinkMacSystemFont, Helvetica Neue, PingFang SC, Microsoft YaHei'
) {
  return {
